...
| numerical magnitude | 数值大小 |
| unit | 单位 |
| base quantity | 基本量 |
| derived quantity | 导出量 |
| SI base unit | SI 基本单位 |
| derived unit | 导出单位 |
| dimension | 量纲 |
...
| momentum | 动量 |
| impulse | 冲量 |
| principle of conservation of momentum | 动量守恒定律 |
| elastic collision | 弹性碰撞 |
| inelastic collision | 非弹性碰撞 |
| moment of a force | 力矩 |
| torque of a couple | 力偶矩 |
| equilibrium | 平衡 |
...
| terminal potential difference | 路端电压 |
| potential divider | 分压电路 |
